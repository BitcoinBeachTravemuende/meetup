  ...
  <div class="py-10">
    <div class="mx-auto h-full items-stretch flex flex-col max-w-[600px] bg-black rounded-lg">
      <div class="relative">
        ...
        <nav
          class="absolute right-0 top-4 h-12 bg-white dark:bg-black rounded-l-xl flex items-center px-2 bg-opacity-50 dark:bg-opacity-40"
        >
    ...
    <footer class="w-full flex flex-col justify-center items-center p-2">
      <div class="bg-white dark:bg-black rounded-full m-4 px-2">
        <VPSocialLinks class="VPNavScreenSocialLinks" :links="theme.socialLinks" />
      </div>
      <p class="text-gray-400 text-sm bg-white dark:bg-black px-2 py-1 rounded-full">
        {{ theme.footerBuiltWith }} <span class="text-orange-400">♥</span> in Travemünde.
      </p>
    </footer>
  </div>
</template>
