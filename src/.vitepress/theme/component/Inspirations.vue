...
<template>
  <div class="relative" :class="class">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
      <div
        ...
        @click="fullscreen = inspiration.source"
      >
        <img
  ...
  >
    ...
    <div
      class="absolute right-6 top-6 p-2 ease dark:bg-white dark:text-black bg-gray-400 text-white peer-hover:opacity-100 peer-hover:bg-orange-400 hover:bg-orange-400 hover:opacity-100 shadow-xl rounded-full"
    >
      <svg
